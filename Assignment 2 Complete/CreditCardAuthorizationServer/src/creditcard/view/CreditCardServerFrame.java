...
/**
 * This class represents the front end of the server side application. It
 * display the status of the server and status for each request made to the
 * server.
 * 
 * @author Group S
 *
 */
public class CreditCardServerFrame extends JFrame {
	 ...
	 */
	public CreditCardServerFrame() {

		// Default frame setting
		getContentPane().setLayout(new BorderLayout());
		this.setTitle("TCP Application: Credit Card Server Side");
